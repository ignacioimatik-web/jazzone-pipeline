...
`
        ...
        />
        <link href="https://fonts.googleapis.com/css2?family=JetBrains+Mono:ital,wght@0,400;0,600;0,700;0,800;1,400;1,700&display=swap" rel="stylesheet" />
        <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap" rel="stylesheet" />
      </head>
      <body className="font-body-lg text-body-lg antialiased" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
        {children}
        {/* Load the original jazzone.js that powers all functionality */}
        <script src="/jazzone.js"></script>
      </body>
    </html>
  );
}
